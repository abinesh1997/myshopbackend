...
const { register, getAllUsers, getUser, updateUser,login, createcodOrder, getOrders, getOrder, orderStatus, getOrdersByUserId} = require("../controllers/userController");
const { protect, checkAdmin } = require("../middleware/protect");

const router = express.Router();
// req requres res response
